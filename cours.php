    ...
    case 'SELECT DISTINCT':
        contentElement.innerHTML = `
            <article id="post-11" class="post-11 page type-page status-publish hentry">
                ...
                <h2>Exemple</h2>
                <p>Prenons le cas concret d’une table “client” qui contient des noms et prénoms:</p>
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                ...
                <p>En utilisant seulement SELECT tous les noms sont retournés, or la table contient plusieurs fois le même prénom (cf. Pierre). Pour sélectionner uniquement les prénoms uniques il faut utiliser la requête suivante:</p>
                ...
                <p>Ce résultat affiche volontairement qu’une seule fois le prénom “Pierre” grâce à l’utilisation de la commande DISTINCT qui n’affiche que les résultats distincts.</p>
            </article>`;
        break;
    ...
    case 'WHERE':
        contentElement.innerHTML = `
            <article id="post-11" class="post-11 page type-page status-publish hentry">
                ...
                <h2>Syntaxe</h2>
                <p>La commande WHERE s’utilise en complément à une requête utilisant SELECT. La façon la plus simple de l’utiliser est la suivante:</p>
